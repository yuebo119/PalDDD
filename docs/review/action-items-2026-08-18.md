...
### [x] ITM-191 · IdempotencyProcessor 未对齐 ITM-180（副作用重放） · ✅
...
### [x] ITM-192 · DapperSagaStateStore SQLite 分支缺类型限定 · ✅
...
### [x] ITM-193 · ProjectionCheckpointDbContext SQLite 分支缺类型限定 · ✅
