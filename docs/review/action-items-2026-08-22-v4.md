...
### [ ] ITM-272 · F1：OutboxStore.MarkProcessed doc 把 Dapper 错归"拒绝"阵营——Dapper 实为放行
...
### [ ] ITM-273 · 第六处三方一致漏网（934c0c6 同提交内）
...
### [ ] ITM-274 · PalOrmInboxStore ProcessingStartedAt=null 静默（R41 勘正暴露的姊妹缺口）
