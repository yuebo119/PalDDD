...
### [x] ITM-209 · 修复 Native AOT `IL2075` 并建立真实运行门禁
...
### [x] ITM-212 · Observer 异常不得重放 Saga 业务步骤
...
### [x] ITM-214 · 修复 MySQL BulkCopy 二进制列损坏
...
### [x] ITM-215 · 修复 PostgreSQL JSONL/CSV 导出
...
### [x] ITM-222 · 修复 Source Generator 不可编译输出与命名碰撞
...
### [x] ITM-232 · 让 CI 和 review scope 覆盖双仓全集
...
### [x] ITM-241 · 补齐跨 Provider 与高级路径矩阵
