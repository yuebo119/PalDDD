...
- 状态：**已收编（2026-08-20）**——本文档并入 `docs/design/unified-quality-system.md`（三层一面统一质量体系 v2.0）作为系统平面的来源方案；裁决点 1/2/3 随收编关闭，裁决点 4（cortex 分层）保留独立裁决。CT-01~16 的处置对照见融合方案 §4/§5
- 日期：2026-08-20
