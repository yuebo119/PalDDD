...
| **PalORM.MySql** | 5.5.1 | PalORM MySQL 方言 Provider：BulkCopy / 多值 INSERT（5.4 弹性层三 Provider 均支持 configureResilience 回调） |
| **PalORM.Sqlite** | 5.5.1 | PalORM SQLite 方言 Provider：FTS5 / JSON1 |
