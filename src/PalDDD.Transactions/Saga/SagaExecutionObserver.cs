...
///   using var _ = new SagaExecutionObserver(new MetricsSink(logger)); // logger 来自你的 DI 作用域
///   //（如 IPalLogger<MetricsSink> logger = NullPalLogger<MetricsSink>.Instance 或注入实例；v67 补来源声明）
