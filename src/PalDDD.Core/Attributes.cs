...
/// </summary>
[AttributeUsage(AttributeTargets.Class, AllowMultiple = false)]
[Obsolete("框架自身零消费（SourceGen/Analyzer 均不读取，精炼裁决 2026-08-26）——v4.0 移除；需要标记语义请在应用层自定义 attribute。", error: false)]
...
[Obsolete("框架自身零消费（原 doc 声称'供 Source Generator 使用'已失实，精炼裁决 2026-08-26）——v4.0 移除；需要标记语义请在应用层自定义 attribute。", error: false)]
